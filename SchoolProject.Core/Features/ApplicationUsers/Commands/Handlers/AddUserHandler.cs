...
{
    internal class AddUserHandler : ResponseHandler, IRequestHandler<AddUserCommand, Response<string>>
    {
        #region Fields
        ...
        #region Constructors
        public AddUserHandler(IStringLocalizer<SharedResources> localizer,
                              IMapper mapper,
